...
- Structure & orientation: README, purpose, repo structure and file names, contact, …  
...
- Code quality: structure, modularity, naming, comments, …  
...
- Reproducibility: absolute paths, seeds, run order, deterministic outputs, …
